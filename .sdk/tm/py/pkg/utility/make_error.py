...
from projectname_sdk.core.control import WaifuFinderControl
from projectname_sdk.core.error import WaifuFinderError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import WaifuFinderContext
        ctx = WaifuFinderContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, WaifuFinderError):
        errmsg = err.msg
    ...
    sdk_err = WaifuFinderError("", msg, ctx)
