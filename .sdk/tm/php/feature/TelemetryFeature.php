...
// WaifuFinder SDK telemetry feature
...
class WaifuFinderTelemetryFeature extends WaifuFinderBaseFeature
{
    ...
    private function _close(WaifuFinderContext $ctx, bool $ok): void
    {
