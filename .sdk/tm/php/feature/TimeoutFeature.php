...
// WaifuFinder SDK timeout feature
...
class WaifuFinderTimeoutFeature extends WaifuFinderBaseFeature
{
    ...
    private function _with_timeout(WaifuFinderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WaifuFinderContext $_ctx, float $ms): void
    {
        $client = $this->client;
