...
// WaifuFinder SDK idempotency feature
...
class WaifuFinderIdempotencyFeature extends WaifuFinderBaseFeature
{
    ...
    private function _mutating(WaifuFinderContext $ctx): bool
    {
