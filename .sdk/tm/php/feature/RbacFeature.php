...
class WaifuFinderRbacFeature extends WaifuFinderBaseFeature
{
    ...
    private function _required(WaifuFinderContext $ctx): ?string
    {
    ...
    private function _reject(WaifuFinderContext $ctx, string $required): void
    {
    ...
    private function _track(WaifuFinderContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
