...
// WaifuFinder SDK netsim feature
...
class WaifuFinderNetsimFeature extends WaifuFinderBaseFeature
{
    ...
    private function _simulate(WaifuFinderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WaifuFinderContext $ctx, array $applied): void
    {
        $client = $this->client;
