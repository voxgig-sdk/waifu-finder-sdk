...
// WaifuFinder SDK clienttrack feature
...
class WaifuFinderClienttrackFeature extends WaifuFinderBaseFeature
{
    ...
    public function PostConstruct(WaifuFinderContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WaifuFinder-SDK';
