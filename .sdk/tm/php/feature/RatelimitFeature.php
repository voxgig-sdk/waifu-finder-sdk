...
// WaifuFinder SDK ratelimit feature
...
class WaifuFinderRatelimitFeature extends WaifuFinderBaseFeature
{
    ...
    private function _acquire(WaifuFinderContext $ctx): void
    {
    ...
    private function _track(WaifuFinderContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
