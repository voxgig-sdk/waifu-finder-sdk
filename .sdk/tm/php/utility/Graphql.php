...
// WaifuFinder SDK utility: graphql
//
...
class WaifuFinderGraphql
{
    ...
    // equivalent.
    public static function body(WaifuFinderContext $ctx): mixed
    {
    ...
    public static function errors(WaifuFinderContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
