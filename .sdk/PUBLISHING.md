...
|---|---|---|
| `ts/` | @voxgig-sdk/waifu-finder-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/waifu-finder-sdk \
      --repository voxgig-sdk/waifu-finder-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/waifu-finder-sdk` shows it, and
`npm trust revoke @voxgig-sdk/waifu-finder-sdk --id=<id>` removes it.
