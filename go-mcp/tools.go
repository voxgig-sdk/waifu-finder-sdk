...
func registerTools(server *mcp.Server, client *sdk.WaifuFinderSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "waifu-finder_list",
		Description: "List records from WaifuFinder. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "waifu-finder_load",
		Description: "Load a single record from WaifuFinder. " +
...
func runOp(client *sdk.WaifuFinderSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WaifuFinderSDK, name string) (sdk.WaifuFinderEntity, error) {
