// Command WaifuFinder-mcp is an MCP server exposing the WaifuFinder
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WaifuFinder_list  — list records of an entity
//	WaifuFinder_load  — load a single record of an entity
//
