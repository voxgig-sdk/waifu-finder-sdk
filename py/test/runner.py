...
class WaifuFinderTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaifuFinderTestRunner.getenv("WAIFUFINDER_TEST_LIVE")
        override = WaifuFinderTestRunner.getenv("WAIFUFINDER_TEST_OVERRIDE")
        ...
        explain = WaifuFinderTestRunner.getenv("WAIFUFINDER_TEST_EXPLAIN")
