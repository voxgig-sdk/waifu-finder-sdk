# WaifuFinder SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WaifuFinderSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WaifuFinderSDK(...) and WaifuFinderSDK.test(...) become
#      WaifuFinderSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "waifufinder_sdk"
_SDK_CLASS = "WaifuFinderSDK"
