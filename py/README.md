# WaifuFinder Python SDK



The Python SDK for the WaifuFinder API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/waifu-finder-sdk/releases)) or
