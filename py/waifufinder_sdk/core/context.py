...
from waifufinder_sdk.core.helpers import get_ctx_prop, to_map
...
class WaifuFinderContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, WaifuFinderSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WaifuFinderResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WaifuFinderResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WaifuFinderError(code, msg, self)
