...
from waifufinder_sdk.utility import register

# Load features
from waifufinder_sdk.feature.base_feature import WaifuFinderBaseFeature
from waifufinder_sdk.features import _has_feature, _make_feature
...
class WaifuFinderSDK:
    ...
    def get_utility(self):
        return WaifuFinderUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WaifuFinderSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Image(self, data=None) -> "ImageEntity":
        ...
        from waifufinder_sdk.entity.image_entity import ImageEntity
        return ImageEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "WaifuFinderSDK":
        if sdkopts is None:
            sdkopts = {}
