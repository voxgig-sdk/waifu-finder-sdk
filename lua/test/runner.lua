...
function runner.env_override(m)
  local live = runner.getenv("WAIFUFINDER_TEST_LIVE")
  local override = runner.getenv("WAIFUFINDER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAIFUFINDER_TEST_EXPLAIN")
