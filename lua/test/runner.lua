...
function runner.env_override(m)
  local live = runner.getenv("WAIFU_FINDER_TEST_LIVE")
  local override = runner.getenv("WAIFU_FINDER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WAIFU_FINDER_TEST_EXPLAIN")
