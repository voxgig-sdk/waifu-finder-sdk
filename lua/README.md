...
The Lua SDK for the WaifuFinder API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/waifu-finder-sdk/releases)),
...
The main module (`waifu-finder_sdk`) exports the SDK constructor
