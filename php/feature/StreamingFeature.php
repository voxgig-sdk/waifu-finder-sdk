...
// WaifuFinder SDK streaming feature
...
class WaifuFinderStreamingFeature extends WaifuFinderBaseFeature
{
    ...
    private function _iterate(WaifuFinderResult $result): \Generator
    {
    ...
    private function _streamable(WaifuFinderContext $ctx): bool
    {
