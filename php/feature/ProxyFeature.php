...
class WaifuFinderProxyFeature extends WaifuFinderBaseFeature
{
    ...
    public function init(WaifuFinderContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WaifuFinderContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
