...
// WaifuFinder SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WaifuFinderTestFeature extends WaifuFinderBaseFeature
{
    ...
    public function init(WaifuFinderContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WaifuFinderContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WaifuFinderParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WaifuFinderContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WaifuFinderContext $ctx, $op, $args): array
    {
