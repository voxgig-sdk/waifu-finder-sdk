...
class WaifuFinderCacheFeature extends WaifuFinderBaseFeature
{
    ...
    private function _through(WaifuFinderContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
