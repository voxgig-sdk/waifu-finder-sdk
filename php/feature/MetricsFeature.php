...
// WaifuFinder SDK metrics feature
...
class WaifuFinderMetricsFeature extends WaifuFinderBaseFeature
{
    ...
    private function _record(WaifuFinderContext $ctx, bool $ok): void
    {
