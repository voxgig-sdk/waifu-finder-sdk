...
// WaifuFinder SDK utility: fetcher

class WaifuFinderFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WaifuFinderSDK/1.0)';
    ...
    public static function call(WaifuFinderContext $ctx, string $fullurl, array $fetchdef): array
    {
