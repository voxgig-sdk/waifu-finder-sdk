# WaifuFinder PHP SDK Reference

Complete API reference for the WaifuFinder PHP SDK.
...
#### `WaifuFinderSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): WaifuFinderUtility`
