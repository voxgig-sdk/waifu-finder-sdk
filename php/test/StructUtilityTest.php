...
// WaifuFinder SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WaifuFinderOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WaifuFinderOmni::structfix($now, Struct::undef()))
                        !== json_encode(WaifuFinderOmni::structfix($val, Struct::undef()))) {
