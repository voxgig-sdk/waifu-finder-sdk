...
class ImageEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $cfg = WaifuFinderConfig::shared_config();
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WAIFU_FINDER_TEST_IMAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function image_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WAIFU_FINDER_TEST_IMAGE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["WAIFU_FINDER_TEST_IMAGE_ENTID"]);
    if ($idmap_resolved === null) {
        $idmap_resolved = Helpers::to_map($idmap);
    }

    if ($env["WAIFU_FINDER_TEST_LIVE"] === "TRUE") {
    ...
    return [
        ...
        "env" => $env,
        "explain" => $env["WAIFU_FINDER_TEST_EXPLAIN"] === "TRUE",
        "live" => $live,
