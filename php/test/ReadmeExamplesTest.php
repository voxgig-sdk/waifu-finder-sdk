...
// WaifuFinder SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WaifuFinderSDK::test)
...
{
    private const SDK_CLASS = 'WaifuFinderSDK';
    ...
    private const SDK_BASE = 'waifufinder_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../waifufinder_sdk.php';
