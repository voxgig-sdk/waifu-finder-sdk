...
require_once __DIR__ . '/../waifufinder_sdk.php';
...
{
    private static function utility(): WaifuFinderUtility
    {
        return new WaifuFinderUtility();
    }
    ...
    private static function ctx(array $over = []): WaifuFinderContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WaifuFinderContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WaifuFinderOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WaifuFinderError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WaifuFinderOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WaifuFinderMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WaifuFinderOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WaifuFinderMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WaifuFinderOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WaifuFinderMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaifuFinderSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WaifuFinderMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WaifuFinderResponse([]),
            'result' => new WaifuFinderResult([]),
        ]);
        [, $err] = WaifuFinderMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec([]),
            'response' => null,
            'result' => new WaifuFinderResult([]),
        ]);
        [, $err] = WaifuFinderMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec(['step' => 's']),
            'response' => new WaifuFinderResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WaifuFinderResult([]),
        ]);
        [, $err] = WaifuFinderMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec(['step' => 's']),
            'response' => new WaifuFinderResponse(self::resp(200, ['v' => 1])),
            'result' => new WaifuFinderResult([]),
        ]);
        [, $err] = WaifuFinderMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec(['step' => 's']),
            'response' => new WaifuFinderResponse(self::resp(200, ['v' => 2])),
            'result' => new WaifuFinderResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WaifuFinderMakeResponse::call($ctx);
    ...
    {
        $preset = new WaifuFinderResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec([]),
            'response' => new WaifuFinderResponse([]),
            'result' => new WaifuFinderResult([]),
        ...
        [$got, $err] = WaifuFinderMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WaifuFinderResult([])]);
        [, $err] = WaifuFinderMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WaifuFinderSpec([]), 'result' => null]);
        [, $err] = WaifuFinderMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaifuFinderSpec(['step' => 's']),
            'result' => new WaifuFinderResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WaifuFinderOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaifuFinderMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaifuFinderSpec(['step' => 's']),
            'result' => new WaifuFinderResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WaifuFinderOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaifuFinderMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaifuFinderResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WaifuFinderSpec([]),
            'result' => new WaifuFinderResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WaifuFinderMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaifuFinderMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WaifuFinderError('boom', 'boom');
        $utility->fetcher = function (WaifuFinderContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaifuFinderSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WaifuFinderMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WaifuFinderContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WaifuFinderMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WaifuFinderResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WaifuFinderMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WaifuFinderContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaifuFinderSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WaifuFinderMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WaifuFinderResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WaifuFinderSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WaifuFinderMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WaifuFinderMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WaifuFinderMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WaifuFinderResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WaifuFinderDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WaifuFinderResult(['ok' => false])]);
        $this->expectException(WaifuFinderError::class);
        WaifuFinderDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WaifuFinderResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WaifuFinderMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WaifuFinderMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WaifuFinderBaseFeature();
        $b = new WaifuFinderBaseFeature();
        WaifuFinderFeatureAdd::call($ctx, $a);
        WaifuFinderFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WaifuFinderBaseFeature
    {
        $f = new WaifuFinderBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WaifuFinderFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WaifuFinderContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WaifuFinderSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaifuFinderPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WaifuFinderPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WaifuFinderResponse(['headers' => null]),
            'result' => new WaifuFinderResult([]),
        ]);
        WaifuFinderResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WaifuFinderResultBody::call($ctx);
