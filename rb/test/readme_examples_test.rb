...
#      offline in seeded test mode (WaifuFinderSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WaifuFinder_sdk.rb")
  SDK_CLASS = "WaifuFinderSDK"
