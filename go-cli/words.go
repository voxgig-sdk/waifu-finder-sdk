...
func registerSDKWords(r *eng.Registry, client *sdk.WaifuFinderSDK) {
...
func runOp(client *sdk.WaifuFinderSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
